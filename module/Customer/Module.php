...
class Module implements AutoloaderProviderInterface
{
    public function onBootstrap(MvcEvent $e)
    {
        ...
        $serviceManager->setService('Zend\Log\Customer', $logger);
                        ...
                        (
                            ...
                            function($e) use ($serviceManager)
                            {
								...
								if ($e->getParam('exception'))
                                {
                                    ...
                                    do
                                    {
                                        $serviceManager->get('Zend\Log\Customer')->crit
                                                                                (
                                                                                    sprintf
                                                                                    (
                                                                                       "%s:%d %s (%d) [%s]\n",
	...
	public function onDispatchError(MvcEvent $event)
	{
			...
			case '400'	:	$errorTitle 	=	'Oops!';
							...
							$messageLines 	=	array
												(
													...
													"Try checking the URL for errors, <a href=\"/CustomerHome\">goto home</a> or try to search below.",
												);
							break;
        ...
        $layout->setTemplate( 'layout/customer/empty' );
