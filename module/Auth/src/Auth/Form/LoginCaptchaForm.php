<?php
/**
 * Class LoginCaptchaForm
 *
 * filename:   LoginCaptchaForm.php
 * 
...
class LoginCaptchaForm  extends Form
                        implements InputFilterAwareInterface
{
    ...
    protected $login_captcha_csrf;

    public function __construct($name = null)
    {
        parent::__construct('LoginCaptchaForm');
                ...
                (
                    ...
                    (
                        ...
                        'attributes'    =>  array
                                            (
                                                'type'      =>  'email',
                                                'id'        =>  'LoginCaptchaFormReturningMemberField',
                                                'class'     =>  'form-control',
                                            ),
                        'options'       =>  array
                                            (
        ...
        $LoginCsrf         =   new CsrfElement('login_captcha_csrf');
        $LoginCsrf->setAttribute('id', 'LoginCaptchaFormCsrfField');
        $LoginCsrf->setCsrfValidator($csrfValidator);
        $this->add($LoginCsrf);

        //assign!
        $this->login_captcha_csrf  =   $LoginCsrf;
        ...
        $this->add
                (
                    ...
                    (
                        ...
                        'name'          =>  'LoginCaptchaFormPasswordField',
                        'required'      =>  TRUE,
                        'attributes'    =>  array
                                            (
                                                'type'      =>  'password',
                                                'id'        =>  'LoginCaptchaFormPasswordField',
                                                'class'     =>  'form-control',
                                            ),
                        'options'       =>  array
                                            (
                                ...
                                $factory->createInput
                                            (
                                                ...
                                                (
                                                    ...
                                                    'validators'    =>  array
                                                                        (
                                                                            $this->login_captcha_csrf->getCsrfValidator(),
                                                                        ),
                                                )
                                            )
                            );
